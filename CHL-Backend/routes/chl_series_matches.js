...
router.post(`${ADD_SERIES_MATCHES}`, (req, res) => {
  ...
  console.log(values);
  const sql = `
      INSERT INTO ${CHL_SERIES_MATCHES} (series_id, match_id, date_display_text, match_number_text, match_format, start_date, end_date, team1_id, team1_name, team1_shortname, team1_imageid, team2_id, team2_name, team2_shortname, team2_imageid, ground_id, ground_name, ground_city) 
      VALUES ?`;
