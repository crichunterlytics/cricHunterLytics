...
export const getBestTenByOneTeam = (playerData) => {
    ...
    // Ensure at least 1 from each role
    if (roles.batter.length > 0) selectedPlayers.push(roles.batter[0]);
    if (roles.bowler.length > 0) selectedPlayers.push(roles.bowler[0]);
    ...
    let remainingPlayers = [
        ...roles.batter.slice(1),
        ...roles.bowler.slice(1),
